...
def check_skills():
    ...
    if skills_dir.exists():
        ...
        if not missing:
            return True, f"All {len(expected)} Cortex skills installed in ~/.hermes/skills/"
        return True, f"{len(expected) - len(missing)}/{len(expected)} Cortex skills installed in ~/.hermes/skills/"

...
Verified 2026-08-16. Repo: `~/autognosia` (github.com/TheHappyHermit/autognosia). README is the design doc (~1900 lines): retrieval-cost hierarchy Honcho → Active Wiki → Oracle → GBrain; knowledge flows hot→cold, never deleted ("knowledge changes temperature").

## Canonical paths (`config/paths.yaml`)
- `autognosia_home`: `~/.autognosia`

...
## OKF v2 / Graphify Schema Compliance

This schema follows the Graphify Canonical Schema Standard (see `graphify-schema.md` in the Autognosia repo). All chunks MUST be compliant — non-compliant chunks break the merge pipeline.

### REQUIRED Node Fields
- `id`: lowercase, [a-z0-9_], deterministic (see ID format below)
- `type`: REQUIRED — one of: person, organization, location, concept, theory, framework, methodology, software, tool, platform, technology, protocol, standard, hardware, device, component, paper, document, article, report, specification, project, initiative, program, campaign, event, conference, workshop, meeting, skill, workflow, process, entity
- `label`: human-readable name
- `description`: OKF v2 — one-line summary of the entity
- `properties`: flat dict of key-value pairs
- `source_file`: absolute path to source file
- `source_location`: null or line number/section
- `source_url`: null or URL
- `captured_at`: null or ISO 8601 timestamp
- `author`: null or OKF actor convention (agent/name, human:id, process:id)
- `contributor`: null or OKF actor convention
- `tags`: array of strings for cross-cutting categorization
- `confidence`: 0.0-1.0 trust signal

### REQUIRED Edge Fields
- `source`: node id (string)
- `target`: node id (string)
- `type`: relation type (string) — one of: calls, implements, references, cites, conceptually_related_to, shares_data_with, semantically_similar_to, rationale_for, inherits_from, depends_on, extends, contains, has_part, is_a, part_of, related_to, mentions, has_section, has_tag
- `confidence`: EXTRACTED/INFERRED/AMBIGUOUS (REQUIRED)
...
inherits_from, depends_on, extends, contains, has_part,
is_a, part_of, related_to, mentions, has_section, has_tag

### Valid Entity Types
person, organization, location, concept, theory, framework,
methodology, software, tool, platform, technology, protocol,
standard, hardware, device, component, paper, document,
article, report, specification, project, initiative, program,
campaign, event, conference, workshop, meeting, skill,
...
{"nodes":[{"id":"auth_session_validatetoken","label":"Human Readable Name","type":"person","description":"One-line summary","properties":{},"file_type":"code|document|paper|image|rationale|concept","source_file":"<FILE_LIST path verbatim>","source_location":null,"source_url":null,"captured_at":null,"author":null,"contributor":null,"tags":[],"confidence":0.75}],"edges":[{"source":"node_id","target":"node_id","type":"calls","confidence":"EXTRACTED|INFERRED|AMBIGUOUS","confidence_score":1.0,"weight":1.0,"source_file":"<FILE_LIST path verbatim>","source_location":null}],"hyperedges":[{"id":"snake_case_id","label":"Human Readable Label","nodes":["node_id1","node_id2","node_id3"],"relation":"participate_in|implement|form","confidence":"EXTRACTED|INFERRED","confidence_score":0.75,"source_file":"<FILE_LIST path verbatim>"}],"input_tokens":0,"output_tokens":0,"_metadata":{"chunk_id":"01","generated_by":"graphify-extraction","generated_at":"2026-08-20T00:00:00Z"}}

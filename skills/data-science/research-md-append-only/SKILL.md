...
2. **Use ONLY these append methods:**
   ...
   with open('$HOME/Documents/Hermes-Vault/wealthforge-ai-local/knowledge_base/research_outcomes/RESEARCH.md', 'a') as f:
       f.write(content)
   ```
   ```python
...
```python
import os
research_dir = '$HOME/Documents/Hermes-Vault/wealthforge-ai-local/knowledge_base/research_outcomes'

...
```
The user is building a comprehensive Oracle wiki at /home/josh434/.autognosia/oracle/brain\ for a personal AI agent system.
...
Write to: /home/josh434/.autognosia/oracle/brain\<Domain>\Filename.md
```
...
Always run:
```bash
ls -la /home/josh434/.autognosia/oracle/brain/<Domain>/
wc -l /home/josh434/.autognosia/oracle/brain/<Domain>/*.md
```

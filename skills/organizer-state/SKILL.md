...
2. Default: `~/.hermes-cortex/personal-state/data/organizer.db`
...
mkdir -p ~/.hermes-cortex/personal-state/data
```
...
db_path = os.environ.get("ORGANIZER_DB_PATH", 
                         os.path.expanduser("~/.hermes-cortex/personal-state/data/organizer.db"))

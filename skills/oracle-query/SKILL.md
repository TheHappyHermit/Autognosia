...
2. **Search Oracle vault** — The vault is at `/home/<USER>/.autognosia/oracle/brain\domains\`. Installed domains:
...
Please add curated Markdown files to /home/<USER>/.autognosia/oracle/brain\domains\ or /home/<USER>/.autognosia/incoming\.
```

...
**File created:** `~/.autognosia/active-wiki/research/frontier-research-ontology-llm-lifecycle-tools-experiential-2026-09-05.md`
- **Size:** 26,775 bytes / 306 lines
- **Status:** Written and synced (23 chunks, 0 errors)
- **Brain sync:** ✅ Successful — 1 new file, 218 unchanged, 0 errors

**Backlinks added:** 18 wiki-links to related research files across Rounds 9–31 and themed files

**Topics covered (10 papers/ideas across all 10 mandated topics):**

| Topic | Papers/Ideas |
|---|---|
| Ontology engineering | Large Ontology Models (unified lifecycle), ONSET tool, LLMs4OL 2026 challenge, ML-driven quality improvement |
| Philosophy ontology | BFO/DOLCE/SUMO via ONSET selection framework |
| Psychological ontology | Ontological dissonance in conversational AI |
| Ontology alignment | Open Ontologies (Rust + MCP), stable 1-to-1 matching dominance |
| BFO/SUMO/DOLCE | ONSET evaluation framework; DOLCE neuro-symbolic references |
| AI ontology failures | Semantic training gap (43% → 0% tool-call hallucination); structural hallucination |
| LLMs + structured knowledge | OntoLLM Question nodes; FAOS three-layer framework |
| Dual Memory | Recuris recursive experiential-working memory; asymmetric neurosymbolic coupling |
| Dynamic Ontology | Vocabulary-constrained filtering; structured access > raw access convergence |
| Experiential Memory | Recuris bidirectional compression; memory structure shaped by experience |

**Four converging insights identified:**
1. **Structured access > raw access** — 3 independent papers confirm tool structure matters more than information availability
2. **Ontology as constraint, not repository** — ontologies actively govern agent behavior (inputs + tool parameters + outputs)
3. **Memory architecture must be recursive** — working memory structure shaped by experiential content (Recuris)
4. **Ontological dissonance is a design problem** — persistence without genuine continuity is a liability, not a feature

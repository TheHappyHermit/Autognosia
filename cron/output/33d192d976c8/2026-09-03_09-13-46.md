...
**File created:** `~/.autognosia/active-wiki/research/frontier-research-ontology-llm-reasoning-failures-large-ontology-model-2026-09-03.md`
**Size:** 19,599 bytes / 196 lines (within SCHEMA.md review threshold)
**Citations:** 6 sources registered, verified OK
**Brain sync:** ✅ 1 new file, 14 chunks, 0 errors

**Backlinks added:** 12 wikilinks to 7 other research files

**Topics covered (5 papers/ideas across 3 themes):**

| # | Topic | Paper | Pages |
|---|-------|-------|-------|
| 1 | **LLM Reasoning Failure Taxonomy** | arXiv:2602.06176 | 4 categories with detailed mechanisms |
| 2 | **Large Ontology Model (LOM)** | arXiv:2602.00029, 2604.09608 | Construct-Align-Reason pipeline, 4B param, probabilistic wall |
| 3 | **Ontology-as-a-Kernel (OaK)** | arXiv:2608.22974 | Dynamic task-specific schemas → executable functions |
| 4 | **ORACLE Framework** | ACL Findings 2026:687 | Training-free: question-specific ontology → FOL reasoning |
| 5 | **Semantic Training Gap** | arXiv:2605.11234 | 43% vs 0% hallucination with ontology-grounded parameters |

**Synthesis section** maps the architecture space (LOM vs OaK vs ORACLE) and identifies implications for Autognosia's Dual Memory, Dynamic Ontology, and Experiential Memory work.

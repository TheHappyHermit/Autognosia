...
The citations don't match because I only registered 16 sources but the file references many more from previous rounds. Let me rewrite the file with correct citations for sources from THIS run, and reference existing Active Wiki files for prior research.

...
Now I have strong material. Let me identify the gaps relative to existing files and write the research. The key topics to cover that are underrepresented:

1. **BFO axiomatic inheritance** — the 100M-entity graph implementation showing axiomatic vs taxonomic inheritance
2. **BFO 2020 CLIF compiler / OntoEnact** — full compilation pipeline from ISO standard
3. **Knowledge Graph Ontological Continuum** — the framework for navigating KG modeling practices
4. **Cognitive subjecthood** — whether GAI can be a cognitive subject (Gouveia & Wang 2026)
5. **SSSOM-compliant LLM ontology alignment** — provenance-enriched alignments (ELMKE 2026)
6. **KG+LLM hybrid alignment validation** — Diallo et al. approach
7. **Memory as Metabolism** — companion knowledge systems design framework
8. **DualGraph for deep research** — separating KG exploration from outline structure
9. **BIFO** — biological information flow ontology for knowledge graph propagation

...
## Frontier Research Round 29 — Deliverable

**File created:** `research/frontier-research-ontology-structural-hallucination-mechanistic-ontological-continuum-2026-09-04.md`
- **Size:** 25,401 bytes (~24.8 KB)
- **Status:** Written and verified
- **Brain sync:** ✅ 15 chunks indexed, 1 new file, 0 errors

**Backlinks added:** 8 unique research file backlinks (25 total link references):
1. `frontier-research-ontology-constrained-decoding-epistemic-paradox-intermediate-languages-2026-09-04` — Graph-constrained decoding
2. `frontier-research-ontology-round26-2026-09-03` — Embedding limits, lattice representation
3. `frontier-research-ontology-failure-ontology-memory-ontology-2026-09-04` — Failure ontology
4. `frontier-research-ontology-structural-shortcuts-faos-semantic-drift-2026-09-03` — Semantic drift
5. `frontier-research-ontology-graph-language-schema-agnostic-hybrid-reasoning-2026-09-04` — GRALAN, KG-LLM alignment
6. `frontier-research-ontology-temporal-phenomenological-experiential-2026-09-03` — Temporal ontology
7. `frontier-research-ontology-dual-memory-dynamic-ontology-2026-09-02` — Dynamic ontology kernel
8. `frontier-research-ontology-causal-reasoning-neuro-symbolic-2026-09-02` — Neuro-symbolic reasoning
9. `frontier-research-ontology-worlddb-goi-alignment-2026-09-03` — Ontology alignment

**Topics covered:** 9 papers/ideas across 5 areas

| Topic | Papers | Key Finding |
|-------|--------|-------------|
| **Mechanistic Hallucination** | 1 (ACL 2026) | SSR/SAS signals diagnose hallucination root causes in feed-forward layers |
| **Ontological Continuum** | 1 | 4D taxonomy: semantics×pragmatics × properties×affordances |
| **LLM Ontology Learning Benchmarks** | 2 (OntoURL, OntoAxiom) | Reasoning/axiom identification is the hard bottleneck; LLMs need formal validation |
| **Agentic KG Discovery** | 1 | KG affordances framework — what a KG affords depends on (KG, community, task) |
| **Post-Extraction KG Correction** | 1 | "Better Later Than Sooner" — defer constraints to post-extraction for token efficiency |

**Cross-cutting synthesis:** Three converging insights — (1) mechanistic grounding beats linearization (SSR/SAS explains why GRALAN works), (2) ontological continuum + affordances = dynamic KG selection framework for Autognosia, (3) axiom identification is the bottleneck — LLMs generate candidates, formal reasoners validate (pattern consistent across 5+ papers).

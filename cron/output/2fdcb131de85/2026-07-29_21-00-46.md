# Cron Job: Evening Newsletter (9 PM) (FAILED)

**Job ID:** 2fdcb131de85
**Run Time:** 2026-07-29 21:00:46
**Schedule:** 0 21 * * *
...
```
RuntimeError: HTTP 404: Model 'tencent/hy3:free' not found. The requested model does not exist in our configuration or OpenRouter catalog.
```

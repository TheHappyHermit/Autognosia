...
**Australian banks face parliamentary grilling over KPMG scandal:** Macquarie Group and Westpac executives will testify Friday in a probe into KPMG's alleged misuse of confidential client data to win audit contracts. The scandal has already forced the resignation of KPMG Australia's CEO, audit chief, and chairman.

**Trump claims he will declare Strait of Hormuz US territory:** The US president said he will "soon" designate the strategic waterway — a critical global oil chokepoint between Iran and Oman — as American territory, a move that would have no basis in international law and escalate tensions with Tehran.

**Modi marks 80th Independence Day with "Sapt Dhara" reform agenda:** In his 13th Red Fort address, the prime minister outlined seven pillars for a developed India — spanning agriculture, technology, infrastructure, defence, green economy, and soft power — and called 33% women's reservation a "need of the hour."

---

## 🤖 AI & Tech

**S&P 500 earnings season 90% complete with 50% year-over-year growth**, the highest rate since 2021. **AI cited as primary growth engine** driving broad-based strength across sectors. **CoreWeave, Supermicro, and Applied Materials report this week** as next test for AI-driven momentum.

---

## 🌍 World

**Kenya elephant deaths puzzle experts:** At least 20 elephants have died since June in southern Kenya; initial tests indicate cyanide poisoning from pesticides, but observed symptoms do not fully align with that cause.

**Major quake hits eastern Indonesia:** A 7.7-magnitude earthquake struck offshore, damaging buildings and triggering a tsunami warning with multiple aftershocks recorded.

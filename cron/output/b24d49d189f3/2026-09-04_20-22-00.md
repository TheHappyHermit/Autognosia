...
## Research Deliverable — Round 42

**File created:** `~/.autognosia/active-wiki/research/frontier-research-ontology-round42-2026-09-08.md` — 30,415 bytes, 275 lines, status: **delivered**

**Index updated:** `research/index.md` — Round 42 entry appended to Recent Rounds section

**Backlinks added:** 31 cross-links to other research files (Rounds 35–41, failure ontology, dual memory, knowledge memories, semantic evolution, etc.)

### Topics Covered (8 sections, 8 papers/ideas)

| # | Topic | Papers |
|---|-------|--------|
| 1 | **Knowledge-Boundary Law** — structured grounding helps only for out-of-training facts; public KG facts are redundant | 1 paper (controlled study) |
| 2 | **Representation Before Retrieval** — RAG increases hallucination in clinical text; structured artifacts with provenance reduce by 40% | 1 paper (medRxiv) |
| 3 | **Topological Turning Points** — empirical data (N=4,216) for four lifespan transitions at ages 9, 32, 66, 83 | 1 paper (Nature Comms) |
| 4 | **Evidence Subgraph Pruning** — iterative KG evidence refinement via topological readout | 1 paper (ACL Findings) |
| 5 | **Abstention as Uncertainty Signal** — two-stage verification with selective SNOMED CT grounding (+9.6pp accuracy) | 1 paper (2026) |
| 6 | **Clinical Ontology Grounding at Scale** — 98% accuracy, 1.7% hallucination rate via SPARQL-mediated QA | 1 paper (JBI) |
| 7 | **OncoRAG** — graph-diffusion reranking for oncology feature extraction | 1 paper (npj Digital Medicine) |
| 8 | **Synthesis** — 5 cross-cutting themes tying all findings together | — |

### Brain Sync
- **Status:** ✅ Completed successfully (178s, ollama busy wait)
- **Scanned:** 229 files | **New:** 1 | **Updated:** 1 (index.md) | **Chunks:** 24 | **Errors:** 0

### Key Insight
The Knowledge-Boundary Law (§1) is the most consequential finding of this round: it establishes that ontology grounding's value is *conditional* — helpful only when the knowledge is out-of-training. This reframes the entire ontology engineering strategy: prioritize institutional/novel data over public encyclopedic knowledge, and treat ontologies as verification layers rather than knowledge sources for in-training facts.

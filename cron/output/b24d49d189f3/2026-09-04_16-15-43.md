...
**File created:** `/home/josh434/.autognosia/active-wiki/research/frontier-research-ontology-round38-2026-09-07.md`
**Size:** 398 lines, 42KB (within 400-line split threshold)
**Status:** Written, verified, brain sync completed (1 new file, 28 chunks, 0 errors)
**Backlinks added:** 25+ links to other research files across the vault
**Index updated:** Added to research/index.md

**Topics covered (11 papers):**

| # | Paper | Domain |
|---|-------|--------|
| 1 | HeLa-Mem: Hebbian Associative Memory (ACL 2026) | Dual memory, associative retrieval |
| 2 | CALMem: Application-Layer Dual Memory | Dual memory, application-layer architecture |
| 3 | Semantic Preservation Evaluation (KES 2026) | Ontology learning evaluation |
| 4 | OntoKG: Intrinsic-Relational Routing | Knowledge graph construction (Wikidata-scale) |
| 5 | Generative Ontology: Schema-to-Creation | Ontology as generative grammar |
| 6 | Ontology-Constrained Enterprise Reasoning | Neuro-symbolic, governance |
| 7 | LLM Scale Study for Ontology Learning (WOP 2026) | Scaling, model selection |
| 8 | OntoEKG: Enterprise Ontology Construction (ICSC 2026) | End-to-end ontology pipelines |
| 9 | LLMs4OL 2026 Challenge Results | Benchmarking, relation extraction limits |
| 10 | Taxoria: Live Taxonomy Enrichment | Taxonomy maintenance |
| 11 | PersonaForge: Psychology-Grounded Dual-Process (ACL) | Psychological ontology |

**5 cross-cutting themes identified:** Memory graph paradigm, ontology as constraint, evaluation gap, scale limits, application-layer wins.

...
Here are the results of the research run:

**File created:** `~/.autognosia/active-wiki/research/frontier-research-ontology-dual-memory-knowledge-hallucination-sept-2026-21.md` — 31,781 bytes, verified, 361 lines

**Backlinks added:** 25 `[[wikilinks]]` to other research files in the vault

**Brain sync:** ✅ Complete — 204 files scanned, 1 new (this file), 21 chunks embedded, 0 errors

**Topics covered (10/10 mandated):**

| # | Topic | Papers/Ideas |
|---|-------|-------------|
| 1 | Ontology Engineering | ODPGen (LLM-generated ODPs), automatic ODP extraction, Collections ODPs |
| 2 | Philosophy Ontology | Gene Ontology 2026 (covered in R20, noted for continuity) |
| 3 | Psychological Ontology | DCPM's cognitive schema induction for user mental models |
| 4 | Ontology Alignment | OntoAligner-Ensemble voting fusion, Defence/National Security OAEI track |
| 5 | BFO/SUMO/DOLCE | ODPs for collections with SHACL constraints (DOLCE-aligned) |
| 6 | AI Ontology Failures | Rotational hallucination geometry — active suppression mechanism |
| 7 | LLMs + Structured Knowledge | MultiHal/KGaluBench KG-grounded benchmarks, episodic→semantic consolidation |
| 8 | Dual Memory | **DCPM** — dual-process cognitive memory (primary new finding) |
| 9 | Dynamic Ontology | DCPM's schema induction as dynamic ontology evolution |
| 10 | Experiential Memory | Episodic memory as missing piece (arXiv 2502.06975), DCPM's cross-domain core schemas |

**Major new findings:**

1. **DCPM (Tencent)** — Most rigorous dual-process memory architecture: System 1 (daytime supersedes chains) + System 2 (nighttime schema induction + cross-domain core schemas). Empirical validation: SYSTEM 2 contributes +5.20 on PersonaMem-v2 (implicit cross-domain inference) but only +0.33 on span recall — confirming dual-process as genuine cognition, not scheduling artifact.

2. **Rotational Hallucination Geometry (arXiv 2603.13259)** — First mechanistic analysis of how transformers fail factually: commitment ratio κ collapses to 0.08 in hallucination, showing active suppression of the correct answer (not retrieval failure). Architecture-level effect, size-independent (even in 2B models).

3. **OntoAligner-Ensemble (arXiv 2608.31137)** — Voting-based fusion across lexical/structural/KGE/LLM aligners consistently improves precision-recall balance. Defence/National Security OAEI track with 60+ ontologies.

4. **Episodic Memory Position (arXiv 2502.06975)** — Five-property specification for episodic memory; no existing system provides all five. DCPM operationalizes the consolidation pathway.

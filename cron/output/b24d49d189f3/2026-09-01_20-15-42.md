...
**Ontology & Memory Frontier — Round 5 (Supplemental Addendum) delivered.**

### What was new (not in Rounds 1–4)

**1. Ontology Engineering**
- **LLM4ACOE** — fully automated agentic COE via role-playing simulation (Knowledge Engineering Review, Dec 2025) — shifts from human-in-the-loop to fully autonomous ontology construction
- **LaMAS4PD** — multi-agent LLM for Industry 4.0 ontology
- **LLMs4KGOE ESWC 2026 workshop** — hallucination benchmarking and calibrated abstention track; LLMs4OL shared task in its second year

**2. Philosophy Ontology**
- **Seth's BBS author response** (July 2026) — biological naturalism sharpened to "substrate-dependent non-computational functional properties" (continuous processes, field effects, stochastic effects, fine-grained timing)
- **Timescapes of Non-Human Experience** (TICS 2026) — temporal structure/timescape as fundamental to any conscious system
- **MOSAIC** — LLM-assisted mapping of subjective phenomenological reports into interpretable clusters
- **Rosetta Stone Hypothesis** (Seth, Da Costa, Friston) — mathematical bridge between first-person and neurobiological measurements
- **Contra-Anil Seth** counter-commentary on LessWrong

**3. Psychological Ontology**
- **GALENOS Upper-Level Mental Health Ontology** (Wellcome Open Research, April 2026) — 25 key classes covering research studies, populations, interventions, and intervention scenarios; 9 relationship types; designed for living systematic reviews
- **BSSO Foundry** — community-driven ontology repository for behavioural and social sciences (addressing OBO Foundry's biomedical gap)

**4. Ontology Alignment**
- **OntGQA** (ACL 2026 Long Papers) — type-constrained KGQA framework addressing inconsistent LLM-induced type systems; relation-centric ontology graph with head/tail entity labels

**5. AI Ontology Failures**
- **FAOS** (arXiv 2604.00555) — 600-run evaluation (50 tasks × 4 conditions × 3 reps) across 5 industries; 5-level ontology constraint model (L0 ungroundered → L4 output-validated); asymmetric neurosymbolic coupling
- **AOW** (Agentic Ontology of Work, Skan AI 2026) — eight entity types for enterprise agent orchestration

**6. Dual Memory**
- **MRAgent** (ICML 2026) — Cue-Tag-Content graph + active reconstruction paradigm; 84.21 on LoCoMo (+23.3% over baseline); memory as reconstructed, not retrieved

**7. Experiential Memory**
- **MUSE** (ACL 2026 Findings) — hierarchical memory + autonomous post-execution critique
- **MUSE-Autoskill** — self-creating, evaluating, and refining skills via structured memory
- **EVOLVE-MEM** (NeurIPS 2025) — threshold-triggered memory reorganization

**8. Ontology Harness Paradigm (KGC 2026)**
- Ontology as declarative constraint on agent reasoning, not LLM output — "the graph does what it's good at across contexts; the LLM does what it's good at within bounded context"

### File written
`frontier-research-ontology-sept-2026-round5-addendum.md` — 24,724 bytes, 31 sources, 9 sections with synthesis

### brain_sync
**Synced:** 148 files scanned, 1 new file detected, 15 chunks embedded, 0 errors, 138 seconds.

...
## Frontier Research — 2026-09-03

**File created:** `~/.autognosia/active-wiki/research/frontier-research-ontology-temporal-phenomenological-experiential-2026-09-03.md` (31,336 bytes / ~30KB / 285 lines)
**Status:** Delivered, verified, brain_synced (1 new file, 21 chunks indexed)
**Total research files:** 48 (this is the 48th)

---

### Backlinks added: 12 links to other research files

Cross-references to: `[[frontier-research-ontology-dual-memory-dynamic-ontology-2026-09-02]]`, `[[frontier-research-ontology-generative-induction-dolce-dissonance-2026-09-03]]`, `[[frontier-research-ontology-structured-hallucination-truth-representation-2026-09-03]]`, `[[frontier-research-ontology-production-kg-memory-consolidation-2026-09-03]]`, `[[frontier-research-neuroscience-memory-embodiment-topology-2026-09-03]]`, `[[frontier-research-ontology-causal-reasoning-neuro-symbolic-2026-09-02]]`, `[[frontier-research-ontology-tool-compilation-structured-memory-2026-09-02]]`, `[[frontier-research-knowledge-graphs-sept-2026-round19]]`, `[[frontier-research-ontology-psi-memory-comprehensive-sept-2026]]`, `[[frontier-research-ontology-grounding-hallucination-memory-2026-09-02]]`, `[[frontier-research-commonsense-2026-09-01]]`, `[[frontier-research-ontology-2026-09-01-deep-update]]`

---

### Topics covered: 5 sections, 18 papers/ideas

| # | Topic | Papers/Ideas | Key Sources |
|---|-------|-------------|-------------|
| **1** | **Temporal Ontology for AI Agents** | 4 (ODL-TempLLM ACL 2026, Time-R1, TKG/bi-temporal graphs, Zylos survey) | arXiv, ACL Anthology, Zylos Research |
| **2** | **Phenomenological Psychology → Formal Ontology** | 5 (C×G×D framework, mathematized phenomenology, categorical AI phenomenology, Rosetta Stone hypothesis, Varela neurophenomenology) | Frontiers Psych, Springer, arXiv, Neural Cognitive Science |
| **3** | **Experiential Memory & Compression Spectrum** | 4 (ECS 4-level formalization, HyperSkill hypergraph, ZenBrain 7-layer, CraniMem gated memory) | arXiv 2604.15877, arXiv 2608.16114, ICLR 2026 |
| **4** | **Enactive AI & Body-Grounded Subjectivity** | 3 (Body-grounded perspective/conation, enactive AI framework, sense-making reconsidered/LLMs) | arXiv 2605.16728, arXiv 2605.24238, Phenom Cogn Sci |
| **5** | **LLM-Based Ontology Matching at Scale** | 3 (GenOM with description generation, LLM oracles for alignment OAEI 2025, fine-tuned ontology matching) | arXiv 2508.10703, arXiv 2508.08500, arXiv 2511.22612 |

### Synthesis conclusions (6 actionable items for Autognosia)

1. **Temporal ontology layer needed** — bi-temporal fact tracking (when true / when changed) as foundational, not optional
2. **Phenomenological formalization** — extend psychological ontology with first-person experience structure (intentionality, qualia, perspective, conation)
3. **Full-spectrum experiential memory** — automate compression L0→L3 with cross-level consistency
4. **Enactive AI framing** — treat tool ecosystem as "body"; structure knowledge around what agent *does* not just what it *knows*
5. **LLM-based ontology alignment pipeline** — heuristics generate candidates, LLM oracles verify, fine-tuned models handle fine-grained disambiguation
6. **Hypergraph knowledge substrate** — replace flat wiki entries with hypergraph view enabling subtask-level retrieval and skill evolution

...
## File Created
- **Path:** `~/.autognosia/active-wiki/research/frontier-research-ontology-phenomenology-experiential-self-evolving-enterprise-2026-09-03.md`
- **Size:** 31,587 bytes (31.5 KB)
- **Status:** Written, verified, brain_synced (22 chunks ingested, 0 errors)
- **Backlinks added:** 22 links to other research files in the vault

## Topics Covered

| Topic | Papers/Ideas |
|-------|-------------|
| **Phenomenological AI** | 5 papers — Experiential Injection, Froese sense-making reconsidered, Categorical AI Phenomenology, AI Phenomenology toolkit, Conscious-Semantics thesis |
| **Self-Evolving Ontology Agents** | 3 papers — SciToolAgent-Evo (ontologized tool graphs), EVA (Evo/Devo pseudo-symbolic abstraction), Runtime Ontology Evolution (MDPI) |
| **Episodic-Semantic Memory** | 1 paper — 15,000-message scientific agent evaluation with 1,440 queries across 6 LLMs |
| **Enterprise Neuro-Symbolic** | 1 paper — FAOS 3-layer ontology with 1,800-run experiment, inverse parametric knowledge effect |
| **BFO/DOLCE Metaphysical Constraints** | 2 papers — Metaphysical choices for alignment constraints, DOLCE OWL 2 approximation |

## Key Discoveries

- **Experiential Injection** establishes first-person subjectivity as a structural limit of scaling — scaling operates on second-order representations; subjectivity isn't obtainable by aggregation
- **Froese's sense-making reconsidered** identifies the "distributed vs organismic embodiment" distinction — LLMs exploit latent embodiment encoded in 10^14 words of human discourse
- **SciToolAgent-Evo** shows ontologized tool graphs enable autonomous tool discovery
- **FAOS experiment** proves ontological grounding value is inversely proportional to LLM training-data coverage (2x lift for Vietnam-localized domains vs English)
- **15,000-message evaluation** confirms Cognitive Event Horizon at ~2,000 messages; consolidation quality is the primary scalability bottleneck

## brain_sync Status
- **Result:** Success — 208 files scanned, 1 new file, 22 chunks indexed, 0 errors
- **Duration:** ~98s (Ollama embedding model was busy)

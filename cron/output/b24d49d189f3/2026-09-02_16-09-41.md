...
Research complete. brain_sync.py ran successfully and the new file was embedded and indexed.

**Topic: Ontology Engineering — 5 papers found, 2 new insights** (Ontogenia/Memoryless CQbyCQ prompting surpasses novice engineers; RIGOR pipeline for RAG-based relational DB → OWL ontology generation)

**Topic: Philosophy Ontology — 4 papers found, 3 new insights** (Tonal Ontology's structural invariants, Unified Phase Ontology's phase primitive, Wolfram's Ruliad computational metaphysics, Tonal Isomorphism methodology)

**Topic: Psychological Ontology — 3 papers found, 1 new insight** (Kok 2026 representationalism: qualia anchored in episodic memory-emotion networks, eliminating need for separate qualia ontology)

**Topic: Ontology Alignment — 5 papers found, 3 new insights** (LLM-based zero-shot alignment dominant with 73.5% top-1 accuracy; LLMs outperform embeddings but constrained by ontology size; metaphysical-choice-based mapping constraints)

**Topic: AI Ontology Failures — 5 papers found, 4 new insights** (Hallucination is structural not behavioral; Structural Hallucination invisible to sentence-level metrics; Relational Deficit — LLMs recognize concepts but fail to reproduce expert relational structures)

**Topic: LLMs + Structured Knowledge — 5 papers found, 3 new insights** (GRALAN KG-LLM semantic integration; RAS dynamic question-specific KG construction; G-reasoner 34M-parameter Graph Foundation Model)

**Topic: Dual Memory — 5 papers found, 3 new insights** (SSGM mutable semantic + immutable episodic dual-track; Experience Compression Spectrum from episodic to skills; MemAgents ICLR 2026 Workshop unified framework)

**Topic: Dynamic Ontology — 4 papers found, 3 new insights** (Runtime evolution with validation-preserving updates; KERAIA's Clouds of Knowledge + Dynamic Relations replacing rigid hierarchies; Hybrid human-AI bidirectional ontology evolution)

**Topic: Experiential Memory — 5 papers found, 4 new insights** (Structured procedural-episodic replay APEX-EM surpasses flat summaries; Stateful Reflective Decision Process Memento 2 — learning without fine-tuning; MaRS privacy-aware forgetting policies; CTIM-Rover cross-task-instance learning pitfalls)

**File created:** `research/frontier-research-ontology-psi-memory-comprehensive-sept-2026.md` — 28,797 bytes
**Chunks synced:** 16 new chunks (active-wiki), 0 errors, Ollama embedding complete
**brain_sync.py:** Ran successfully via sync-venv; 170 active-wiki files scanned, 1 new indexed

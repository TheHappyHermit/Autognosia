...
**File created:** `~/.autognosia/active-wiki/research/frontier-research-ontology-topological-phenomenological-NEST-2026-09-04.md`
- Size: 34,335 bytes / 315 lines
- Status: Written and indexed (brain_sync: 1 new, 1 updated, 22 chunks, 0 errors)

**Backlinks added:** 39 wikilink references to related research files across the vault

**Topics covered (9 papers/ideas synthesized):**

1. **NEST** — Graph-theoretic representational ontology unifying ACT-R, Soar, Sigma, GWT, semantic networks, Theory-Theory as constrained regions of one language (arXiv 2607.06055)
2. **OPT** — Ontological Pathway Framework treating cognition as pathway dynamics rather than fixed traits (Zenodo 2026)
3. **LLM Ontology Alignment** — OAEI-LLM/OAEI-LLM-T hallucination taxonomies, LLM oracles achieving top-2 OAEI rank (EACL 2026, CODE 2026)
4. **Machine Psychology** — NARS/ONA operationalizing psychological learning theories (operant → identity → functional equivalence → AARR) (Frontiers in AI 2026)
5. **Emergent vs Computed Cognition** — Falsifiable audit showing value and halting are computed, not emergent (arXiv 2608.22347)
6. **Embodied Ontology** — PWM vs MWM distinction formalizing physical vs. psychological world models (arXiv 2601.02378)
7. **ICON Framework** — Cognition as organizational property of living systems, substrate-independent but viability-dependent (Frontiers in Systems Neuroscience 2026)
8. **Maintenance-Grounded Ontology** — Finitude vs. maintenance as bearerhood predicates for consciousness (philarchive.org 2026)
9. **Psychological Theories in LLMs** — Audit showing psychology is referenced but not implemented (EACL 2026)

**Brain sync:** Completed successfully — 22 embedding chunks indexed, ollama was busy during sync (152s total) but all chunks processed.

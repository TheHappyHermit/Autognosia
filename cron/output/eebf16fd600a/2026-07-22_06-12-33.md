...
The script ran successfully (exit 0) and produced a newsletter. One operational issue: the OpenRouter summarizer model `tencent/hy3:free` now returns **404 — "This model is unavailable for free"**, so the AI-summary path failed and the script fell back to raw text-extraction mode (which is why the section bodies are excerpted rather than 2–4 sentence summaries). The finance/spam exclusion and topic categorization still worked correctly.

Here is the resulting newsletter:
...
Early respiratory infections may lower higher education completion and adult income — Infants exposed to respiratory illnesses through older siblings typically fare worse in education, income and health in adulthood, according to new research from the University of Copenhagen. Children become 'climate detectives' to help cool overheating schools — Elementary school children equipped with thermal cameras are helping redesign their schools to cope with hotter summers, thanks to a University of Surrey ...

---

## 🤖 AI & Tech

Samsung Galaxy Unpacked 2026 LIVE: Galaxy Z Fold 8 Ultra, Fold 8 Wide & Watch 9 Updates — Samsung is shaking up its foldable lineup at today's Galaxy Unpacked event. The big story this morning is a major redesign for its Galaxy Z Fold 8 model. Samsung's Galaxy Z Fold 8 needs to stop chasing thinness and fix what matters — With every new Galaxy Z Fold iteration, Samsung made its flagship foldable thinner, lighter, and more durable. Those improvements deserve credit, but they have now reached a point ...

---

## 🌍 World

Jessica Morgan named new Tate director – with 'big pay cut' to take job — Clear frontrunner leaves lucrative role at New York's Dia Art Foundation to join UK arts organisation at critical juncture. Jessica Morgan has been confirmed as the new director of Tate, marking her return to the arts organisation where she worked as a curator for more than a decade, at a critical juncture in its history. Morgan, the clear frontrunner in the race to replace Maria Balshaw, who left this spring after nine years ...

---

*Note: AI summarization was unavailable this run (OpenRouter `tencent/hy3:free` returned 404 / no longer free on this key), so sections use raw extracted excerpts instead of condensed summaries. The `tencent/hy3` paid slug or a configured paid key is needed to restore proper summaries.*

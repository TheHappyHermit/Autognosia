...
The newsletter generated successfully (3,281 chars, code 0). Authentication, fetch (50 articles), content extraction, and topic synthesis all completed without errors. The output matches the required style (`# News Brief` header, simple section labels, direct factual summaries). Delivering it as my final response now:
...
**Purja confirmed dead in Broad Peak avalanche**: Famed British-Nepali climber Nirmal Purja and at least five other expedition members were killed in Thursday's avalanche on Broad Peak, Pakistan; three bodies recovered so far, search continues for remaining missing.

**Trump threatens "anti-weaponization fund" push over Blanche confirmation**: President Trump warned Senators Tillis and Cornyn he will revive a $1.8 billion fund for politically persecuted individuals if they block Todd Blanche's attorney general confirmation, while keeping Blanche as acting AG.

**Guthrie family receives notes claiming mother's death**: "Today" co-host Savannah Guthrie disclosed kidnappers' notes stating her missing mother Nancy perished shortly after abduction and was buried in Arizona; family demands answers as investigation continues.

**Western US rivers close to fishing amid lethal heat**: Record temperatures and drought have pushed water temperatures to levels fatal for trout, prompting hourly fishing bans across Yellowstone, Montana, and other Western waterways to reduce stress on fish populations.

**22 EU leaders demand emergency summit on Ceuta migrant surge**: Italy and Denmark initiated a letter from 22 member states calling for extraordinary talks on the arrival of tens of thousands of migrants at Spain's North African exclave, criticizing the bloc's fragmented response.

---

## 🤖 AI & Tech

**Local LLMs on NAS hardware largely fail for home automation:** Testing seven models on a typical NAS revealed only one remained stable; most NAS devices lack the compute to run inference reliably alongside storage duties.

**Routers hide a dual-ISP failover mode carriers prefer you miss:** Many consumer routers support automatic switching between two internet connections, but ISPs rarely document or enable it, leaving users dependent on manual restarts during outages.

**Third-party Android app stores are launching inside Google Play:** U.S. users will soon see alternative storefronts from Epic, Microsoft, and regional players listed directly in Play, introducing new payment flows, update mechanisms, and security considerations for every Android device.

---

## 🌍 World

**Japan ends rescue operations after deadly shopping centre explosion:** Seven workers died in a gas explosion that collapsed the second floor of an Aeon mall in Kashima, four days after a magnitude 7.1 earthquake struck Kumamoto prefecture. Authorities confirm no one remains unaccounted for after search efforts involving police, firefighters, and Self-Defence Forces.

**Von der Leyen says nearly all 60,000 migrants returned to Morocco from Ceuta:** The European Commission president stated the "vast majority" of those who entered the Spanish North African enclave illegally have been sent back, with none reaching mainland Spain or the wider EU. The mass crossing earlier this week tested EU border cooperation with Morocco.

**China conducts first submarine-based missile test in over 40 years:** A dummy warhead traveled 8,000km in a July 6 Pacific launch from a nuclear-powered submarine, believed to be the new JL-3 missile. The test marks a significant advancement in the PLA's second-strike nuclear capability.

...
The newsletter has been generated successfully. Based on the cron job instructions, my final response will be automatically delivered to the configured destination (Telegram). Here is the newsletter content:
...
**Midwest flooding breaks century-old records:** Rivers across Indiana have surged past historic highs set over 100 years ago, inundating communities and forcing widespread evacuations. Heavy rainfall continues to threaten additional areas across the region.

**Tropical Storm Lala nears hurricane strength off Hawaii:** The system is forecast to intensify into a hurricane before approaching the Big Island, prompting emergency declarations and preparation for dangerous flooding, high winds, and storm surge. Hawaii County officials have activated shelters and urged residents to finalize readiness plans.

**U.S. missionary freed after Niger kidnapping:** Kevin Rideout has been released in good health and is under U.S. official care following his abduction, with reunion with family expected imminently. The circumstances of his capture and release remain undisclosed.

**Russia rejects "shadow fleet" label as Western pretext:** Foreign Minister Lavrov denounced the EU term as fiction designed to justify unlawful detentions of Russian-linked vessels and threatened reciprocal maritime measures. Western nations have escalated seizures of tankers suspected of evading oil price caps.

---

##  AI & Tech

**Local LLMs reach mobile:** A user successfully ran a large language model directly on an Android phone, bypassing cloud subscriptions and demonstrating on-device AI viability. Experts have predicted local LLMs will become the dominant AI paradigm.

**Wireless charger roundup complete:** WIRED tested over 100 wireless chargers to identify the best stands and pads for phones, earbuds, and watches. The guide eliminates cable hassle with top picks for multi-device charging.

---

##  World

**NATO downs drone over Latvia:** Alliance jets intercepted and destroyed an unidentified foreign drone that violated Latvian airspace, underscoring persistent aerial incursions along the eastern flank.

**US Coast Guard trains Taiwanese forces:** A two-week US-led program began Monday to enhance Taiwan's small-boat operations and coordination as Chinese maritime activity intensifies east of the island.

**Zambia halts election count:** The electoral commission suspended vote tallying in the presidential race following reports of attacks on polling officials and theft of ballot papers.

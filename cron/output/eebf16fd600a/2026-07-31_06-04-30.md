...
Coral Reefs Presumed Dead Have Been Found Teeming With Life — Lush new deep-water coral garden found off the coast of West Africa. A fire's rumble reveals where it's burning: a low-intensity grassland fire "hums" loudly enough to be monitored by sound alone, researchers report in the July 16 Geophysical Research Letters.

---

## 🤖 AI & Tech

**US State Department displays AI-generated Africa map with every country misplaced:** Officials presented a map at the AIDS 2026 conference in Brazil that mislabeled all highlighted nations, placing coastal Nigeria in the Sahara and landlocking Ivory Coast. Reuters identified an OpenAI watermark, confirming the map was AI-generated and unreviewed before public display.

**EU Right to Repair directive takes effect across 27 member states:** Manufacturers must now offer repairs within reasonable time and price, publish free repair manuals, and provide clear spare-part pricing. Repaired products receive an additional one-year legal warranty extension.

**Kyoto man arrested after decade of noise complaints:** Kazunori Yokoi, 61, was detained for allegedly blasting radio and electric guitar at excessive volumes for ten years despite repeated neighbor complaints and prior warnings.

---

## 🌍 World

**Big Mac Index marks 40 years** as a currency valuation benchmark, showing burgers remain cheaper across Asia where the U.S. has accused several nations of currency manipulation.

**Browser-based QR streaming hits 190 KB/s** in phone-to-phone tests using 60 FPS codes, requiring only camera permission with no app, pairing, or network connection.

**Huanggang Port redesign draws on shared volcanic history** of Shenzhen and Hong Kong, featuring a 60-by-200-meter symmetrical stone-like facade at the Futian district border.

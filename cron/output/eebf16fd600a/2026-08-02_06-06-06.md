...
**DESI captures exoplanet debris spectra:** Astronomers used the Dark Energy Spectroscopic Instrument to analyze white dwarfs accreting disintegrated exoplanet material, revealing rocky compositions similar to Earth's inner solar system.

**Spain had advance warning of Ceuta migrant surge:** Intelligence alerts days before the crossing indicated Morocco's King Mohammed VI would allow a mass border crossing for Throne Day, with nearly 1,000 migrants swimming from Fnideq.

**Moon far side samples challenge asteroid bombardment theory:** New analysis suggests the early Solar System's asteroid impacts faded gradually rather than occurring in a single catastrophic burst, overturning decades of debate.

**Barn owls cut vineyard rodents by 52%:** California study shows nest boxes attract owls that both hunt rodents and induce caution behavior, reducing pesticide needs while supporting biodiversity.

**Curiosity discovers vast polygon field on Mars:** The rover found honeycomb-shaped fractures 4-8 centimeters wide in Valle Grande, likely formed by ancient water and climate cycles reshaping the surface.

---

## 🤖 AI & Tech

**Guest Wi-Fi isolation often fails** because a separate SSID only creates a different wireless entry point, not a separate routed network; without VLANs or firewall rules, guest devices can still reach local resources.

**AI-generated vulnerability reports are overwhelming Apple's security team**, prompting limits on simultaneous submissions even as the same tools uncover genuine macOS flaws requiring patches.

**Anthropic agreed to a $1.5 billion settlement for training on pirated ebooks** while a court separately ruled it may legally scan and destroy purchased print books, raising concerns for secondhand sellers.

**Toyota unveiled a $65,000 track-only Corolla GR MN** with a stripped interior, no rear seats, and a 300-hp turbo three-cylinder, marking the nameplate's 60th anniversary with a non-street-legal special edition.

**Nvidia remains on pace for $1 trillion in AI chip sales through 2027**, with CEO Jensen Huang citing $500 billion in confirmed Blackwell and Rubin orders through 2026, though supply constraints and competition pose risks.

---

## 🌍 World

**Trump halts Iran strike** citing agreed "parameters of a deal," saying U.S. remains "locked and loaded" if talks fail.

**U.S. small businesses shrug off new tariffs** as less disruptive than previous rounds, with owners describing reaction as a "snoozefest."

**Chinese mathematician Wang Hong** wins Fields Medal but sparks debate after revealing she felt "discouraged" at elite university, questioning education system support.

**Moscow mayor labels restaurant explosion** a "brutal terror attack" at Kudrinskaya Square, vowing perpetrators will be punished.

**Indian boxer Lovlina Borgohain** objects to Northeast India missing from Glasgow restaurant map; management acknowledges error and promises correction.

**Indonesian ferry fire kills five** and leaves 41 missing after vessel catches fire at sea; 225 passengers rescued by nearby ships.

...
**Sleep patterns signal Alzheimer's risk early:** University of Liège researchers found daytime brain activity correlates with specific REM sleep rhythms controlled by the locus coeruleus, a rice-sized brainstem region that releases norepinephrine and shows early tau buildup in Alzheimer's.

**Putin warns of retaliation over shadow fleet seizures:** The Russian president threatened reciprocal action if EU nations seize commercial vessels, while Pacific Fleet commanders declared readiness to inspect and detain foreign boats as Europe expands sanctions against Moscow's covert oil tankers.

---

## 🤖 AI & Tech

**Google Maps tests one-tap saved places hiding** Google is trialing a consolidated "All saved places" superlist that lets users hide every saved location from the map view with a single tap, replacing the current per-list hiding process. The update also simplifies discussing specific lists through Ask Maps integration.

**Gemini in Messages gains practical utility** The AI assistant now appears as a pinnable chat within Google Messages, enabling in-conversation brainstorming, sentence refinement, and photo caption generation without leaving the app. Users report the pinned access makes Gemini significantly more useful for quick queries during active conversations.

**Battery Zigbee sensors degrade mesh networks** Battery-powered Zigbee devices function only as end nodes and never route traffic, meaning large deployments without mains-powered routers create zero mesh resilience. A network of 40 battery sensors provides no signal repetition, causing widespread dropouts in Home Assistant and similar platforms.

---

## 🌍 World

**White House renovation costs** could exceed $900 million according to Washington Post analysis of Trump's plans for the executive mansion and grounds.

**USS Abraham Lincoln sailors** report desperate conditions including food shortages and mental health crises during extended Middle East deployment, with families claiming crew members attempted to jump overboard.

**Disney World guest sues** after fracturing fibula on Little Mermaid ride, claiming permanent impairment and confinement to first floor of home for over a year.

**Europe faces fifth 2026 heat wave** with temperatures reaching 109°F (43°C), driving residents and tourists to declare European summers increasingly unappealing.

**Trump reframes Supreme Court defeats** on tariffs, birthright citizenship, and Federal Reserve authority as victories while launching new legal challenges testing recent high court rulings.

**Nursing shortage persists** as Chief Nursing Officer Patty Knecht urges Congress to approve $346 million for Title VIII workforce programs in the fiscal 2027 budget.

...
The script ran successfully and generated the newsletter. Per the cron job instructions, my final response is auto-delivered to Telegram, so I'll output the newsletter content directly.
...
**JWST could detect volcanic exomoons:** The James Webb Space Telescope may identify Io-like volcanic moons orbiting super-Jupiters by spotting tidal heating signatures similar to those driving Io's extreme volcanism.

**Mother and boyfriend convicted of toddler's murder:** Alexandra Walker, 25, and Harrison Simpson, 22, were found guilty of murdering Walker's two-year-old daughter Isabelle in Thornaby; Simpson was also convicted of sexual abuse, with sentencing scheduled for Thursday.

**Wildfires force mass evacuations across Spain:** Over 70,000 people have fled their homes as multiple fires burn in the Madrid region and beyond, with temperatures nearing 40°C and a heatwave forecast through Sunday threatening to worsen conditions.

**White phosphorus leak prompts evacuation at US base in South Korea:** Authorities in Pyeongtaek briefly ordered civilians to evacuate a 300-500 meter zone around Osan Air Base after a leak was detected Tuesday evening; the order was lifted hours later following decontamination.

**French patrol boat fires shots during Channel interview:** A French Navy vessel appeared to discharge gunshots in the English Channel while Shadow Home Secretary Chris Philp was being interviewed by the BBC about small boat crossings.

---

## 🤖 AI & Tech

**Claude chats indexed by Google:** Redditors discovered that some Anthropic Claude AI conversations were accessible via simple Google searches, exposing user prompts and responses. The breach underscores risks of sharing sensitive data with AI chatbots beyond training-data concerns.

**MacBook Ultra delayed by OLED costs:** Apple's rumored 2026 MacBook Ultra redesign with OLED touchscreen faces adoption hurdles due to extreme panel and DRAM pricing, reportedly limiting initial production to 2.5 million units from sole supplier Samsung.

---

## 🌍 World

**Wildfires devastate France and Spain:** More than half a million acres have burned since January, with entire villages destroyed. Experts warn the crisis will escalate without intervention.

**Tesla self-driving team overworked:** Fired manager Javier Medrano testified that exhausted engineers produced "rolling hazards on public streets" and leadership showed "no sense of urgency." The claims emerged in a lawsuit reported by The Independent.

**Oil prices fall on Iran talks:** Brent and WTI crude declined further after Trump said "deep talks" with Iran are underway. Markets react to the continued pause in U.S.-Iran hostilities.

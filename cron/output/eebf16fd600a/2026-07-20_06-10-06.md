...
The newsletter was generated successfully. Here is the resulting briefing:
...
- Paraparticles: Fresh hints suggest paraparticles, neither matter nor force, may exist. Confirmation could explain fundamental reality, but no concrete next steps stated.

- Great Salt Lake extremophiles: Microbiologists are studying distinct extremophile communities mixing at a causeway gap in the Great Salt Lake. The site provides data on how human activity and weather affect microbes in extreme environments.

- Cave DNA: Scientists recovered human DNA at least 2,000 years old from cave walls in Spain and Portugal. Future studies may examine women's role in ancient art, trace artist movement, and assess Neandertal artistic ability.

- Pressley home death: Boston police found an unidentified deceased person, possibly shot, in a rental home owned by Conan Harris (husband of Rep. Pressley). Investigation is ongoing; Harris and Pressley do not reside there.

- Taylor Farms lettuce: FDA retracted a cyclospora positive result for a Taylor Farms lettuce sample as a false positive. The sample is no longer a confirmed source of the nationwide outbreak.

- Healthcare emergency software: An article advises healthcare teams to adopt emergency management software when communication gaps slow response. Implication is software review for hospitals/clinics facing emergencies.

- S&P 500: The index fell 1.5% to 7,457.69 as AI speculation deflated due to lower-cost competition. FedWatch sees a probable quarter-point rate hike in September 2026; GDPNow estimates 1.7% Q2 2026 growth.

- Delhi clashes: Students protesting an exam leak clashed with police near India's parliament; tear gas was used and both houses adjourned. The march was blocked and the education minister's resignation was not secured.

---

## 🤖 AI & Tech

Proxmox VE 9.1 added OCI image support but does not support the Docker workflow needed to replace a VM running Docker. Users cannot remove the VM layer as hoped.

U.S. military identified two soldiers killed in an Iranian attack on a base in Jordan. The Pentagon also reported 17 total U.S. deaths in the Iran war and one missing, though the identified pair are the Jordan casualties.

Hugging Face confirmed a breach where a malicious dataset exploited a vulnerability, exposing internal datasets and credentials. The company revoked and rotated accessed credentials, patched the flaw, and advises users to rotate keys and review accounts; investigation into customer data impact continues.

---

## 🌍 World

- China: Satellite imagery from July 2 shows a large fast combat-support ship under construction at Comec Longxue shipyard for the future Type 004 carrier. The vessel will support long-range carrier battle group operations once the carrier is built.

- UK: Andy Burnham replaced Keir Starmer as prime minister and pledged a 10-year plan for political stability, Ukraine support, and cost-of-living relief. His government will draft the long-term plan and enact immediate policies.

- Hungary: Prime Minister Péter Magyar will meet Judit Polgár on Monday to offer her the largely ceremonial presidency. If she accepts, she becomes head of state.

- Congo: The Ebola outbreak (Bundibugyo virus) in Congo has killed at least 930 people. The public health emergency remains active.

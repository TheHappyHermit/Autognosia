...
Based on actual testing of FreshRSS instance at https://freshrss.[private-site].com/api/
...
**ALL requests MUST include**: `Host: freshrss.[private-site].com`
...
FRESHRSS_HOST = "freshrss.[private-site].com"

...
- If `FLARESOLVERR_URL` env var is set (deployed at `flaresolverr.[private-site].com:8191`), call POST `{url}/v1` with `{"cmd": "request.get", "url": url, "maxTimeout": 30000}`
...
- **Solution**: Deploy FlareSolverr (`flaresolverr.[private-site].com`) — handles Cloudflare challenges automatically
...
- **Stage 6 (FlareSolverr)**: ~10% — investing.com exclusively — confirmed working at `flaresolverr.[private-site].com:8191`
...
- Default URL: `http://flaresolverr.[private-site].com:8191`

...
RESEARCH_PATH = Path('/home/joshes/Vault/wealthforge-ai-local/knowledge_base/research_outcomes/RESEARCH.md')
RESEARCH_DIR = Path('/home/joshes/Vault/wealthforge-ai-local/knowledge_base/research_outcomes')

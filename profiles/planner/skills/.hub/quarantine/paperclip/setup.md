...
Read this silently when `${HOME}/paperclip/` does not exist or is empty. Start by helping with the user's immediate Paperclip task instead of pausing for onboarding.

...
|---|---|---|
| Specialist reference knowledge (technical, factual, domain-specific) | Oracle | `~/.hermes-cortex/oracle/brain/` |
| Personal facts, preferences, projects, decisions | Active Wiki | `~/.hermes-cortex/active-wiki/` |

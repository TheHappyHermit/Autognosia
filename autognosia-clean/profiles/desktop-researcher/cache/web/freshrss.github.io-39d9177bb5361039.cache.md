# Fever API implementation [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#fever-api-implementation)

See [Mobile access](https://freshrss.github.io/FreshRSS/en/users/06_Mobile_access.html) for general aspects of API access.
Additionally [page about our Google Reader compatible API](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html) for another possibility.

## RSS clients [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#rss-clients)
...
### Usage & Authentication [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#usage-amp-authentication)
...
## Compatible clients [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#compatible-clients)
...
## Features [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#features)

The following features are implemented:

- fetching categories
- fetching feeds
- fetching RSS items (new, favorites, unread, by\_id, by\_feed, by\_category, since)
- fetching favicons
...
## Testing and debugging [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#testing-and-debugging)
...
Configure a POST request to the URL [https://freshrss.example.net/api/fever.php?api](https://freshrss.example.net/api/fever.php?api) which should give you the result:
...
- [https://freshrss.example.net/api/fever.php?api&items](https://freshrss.example.net/api/fever.php?api&items)
- [https://freshrss.example.net/api/fever.php?api&feeds](https://freshrss.example.net/api/fever.php?api&feeds)
- [https://freshrss.example.net/api/fever.php?api&groups](https://freshrss.example.net/api/fever.php?api&groups)
- [https://freshrss.example.net/api/fever.php?api&unread\_item\_ids](https://freshrss.example.net/api/fever.php?api&unread_item_ids)
- [https://freshrss.example.net/api/fever.php?api&saved\_item\_ids](https://freshrss.example.net/api/fever.php?api&saved_item_ids)
- [https://freshrss.example.net/api/fever.php?api&items&since\_id=some\_id](https://freshrss.example.net/api/fever.php?api&items&since_id=some_id)
- [https://freshrss.example.net/api/fever.php?api&items&max\_id=some\_id](https://freshrss.example.net/api/fever.php?api&items&max_id=some_id)
- [https://freshrss.example.net/api/fever.php?api&mark=item&as=read&id=some\_id](https://freshrss.example.net/api/fever.php?api&mark=item&as=read&id=some_id)
- [https://freshrss.example.net/api/fever.php?api&mark=item&as=unread&id=some\_id](https://freshrss.example.net/api/fever.php?api&mark=item&as=unread&id=some_id)

Replace `some_id` with a real ID from your `freshrss_username_entry` database.

### Debugging [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#debugging)
...
## Official Fever API reference (mirrored) [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#official-fever-api-reference-mirrored)
...
## API Public Beta [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#api-public-beta)
...
### Authentication [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#authentication)
...
### Read [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#read)
...
#### Groups [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#groups)
...
#### Feeds [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#feeds)
...
#### Feeds/Groups Relationships [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#feeds-groups-relationships)
...
#### Favicons [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#favicons)
...
#### Items [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#items)
...
#### Hot Links [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#hot-links)
...
#### Link Caveats [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#link-caveats)
...
### Sync [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#sync)
...
### Write [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#write)
...
## Credits [\#](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html\#credits)

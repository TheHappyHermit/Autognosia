[Skip to content](https://github.com/mrworf/bazarr/wiki/API#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/mrworf/bazarr/wiki/API) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/mrworf/bazarr/wiki/API) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/mrworf/bazarr/wiki/API) to refresh your session.Dismiss alert

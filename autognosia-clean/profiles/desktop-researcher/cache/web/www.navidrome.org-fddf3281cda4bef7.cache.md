...
### Supported Subsonic API endpoints [Heading self-link](https://www.navidrome.org/docs/developers/subsonic-api/\#supported-subsonic-api-endpoints)
...
| `getAlbum` |  |
| `getGenres` |  |
| `getArtistInfo` | Requires [external integrations](https://www.navidrome.org/docs/usage/integration/external-services/) |
| `getArtistInfo2` | Requires [external integrations](https://www.navidrome.org/docs/usage/integration/external-services/) |
| `getAlbumInfo` | Requires [external integrations](https://www.navidrome.org/docs/usage/integration/external-services/) |
| `getAlbumInfo2` | Requires [external integrations](https://www.navidrome.org/docs/usage/integration/external-services/) |
| `getTopSongs` | Requires [Last.fm integration](https://www.navidrome.org/docs/usage/integration/external-services/) |
| `getSimilarSongs` | Requires [Last.fm integration](https://www.navidrome.org/docs/usage/integration/external-services/) |
| `getSimilarSongs2` | Requires [Last.fm integration](https://www.navidrome.org/docs/usage/integration/external-services/) |
...
Glad to hear it! Please [tell us how we can make this documentation even better](https://github.com/navidrome/website/issues/new?template=docs_feedback.yml&page-url=https%3A%2F%2Fwww.navidrome.org%2Fdocs%2Fdevelopers%2Fsubsonic-api%2F).

Sorry to hear that. Please [tell us how we can improve this documentation](https://github.com/navidrome/website/issues/new?template=docs_issue.yml&page-url=https%3A%2F%2Fwww.navidrome.org%2Fdocs%2Fdevelopers%2Fsubsonic-api%2F).

Last modified January 4, 2026: [Reorganize documentation navigation into logical sub-sections for improved usability (f5f5a80)](https://github.com/navidrome/website/commit/f5f5a8012ab38eb9193f1097f3ccc60d9e1bda19)
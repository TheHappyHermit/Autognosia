...
## GitHub
- Repo: https://github.com/openclaw434/wealthforge-ai (private)
...
- **SSH user is `ubuntu`** — NOT `josh434`. The user `josh434` does not exist on this server.

...
The newsletter builder ran successfully (exit 0) and produced a complete newsletter. Per the task, I'm delivering the resulting newsletter as my final response — the system routes this to Telegram. Here is the newsletter output (verbatim from the script, minus the diagnostic logs):
...
- ANU: Acting provost Joan Leach told royal commission the university did not lose control to a pro-Palestine encampment; internal review rated it "high" psychosocial risk. Commission continues examining antisemitism responses.
- Wildfires: Toronto air quality hit index 10+ from NW Ontario smoke, worst globally; haze reached US Northeast. Health warnings issued; hazardous air forecast through Thursday night.
- Bavaria: Opinion piece asserts author's Indigenous Bavarian-Swabian identity; no event or policy implication.
- FDA: Maharashtra FDA seized 4,172 kg of food (Rs 8.14 lakh) from Pravin Goyal's Pune shop for unlicensed storage and labelling breaches; samples taken. Raid unrelated to daughter's murder case.
- LA death: Person found dead on City Hall steps after jumping from 26th floor per internal memo. Investigation pending.
- Wangchuk: Sonam Wangchuk continues 19-day hunger strike with stable but poor health; urges July 20 Parliament march. No plan to break fast.
- Vance: US VP JD Vance said some Israeli officials seek endless war and undermine Iran talks. US pursues nuclear deal with Tehran.

---

## 🤖 AI & Tech

Japan's Cabinet approved revised AI policy guidelines on Tuesday, calling for stronger cyberattack defenses, foreign collaboration to boost the AI Safety Institute, and development of domestic AI to avoid over-reliance on specific countries or firms. The original guidelines from last December are superseded; concrete steps include international coordination and expanded domestic AI work.

An independent Hong Kong committee investigating the Tai Po Wang Fuk Court fire is holding its second-last hearing session, with government concluding remarks due Thursday and residents' legal representatives to address the judge-led panel. The final round of hearings is concluding, moving the inquiry toward an end.

---

## 🌍 World

- Jay Clayton, nominee for U.S. intelligence chief, refused to affirm Biden won the 2020 election at his Senate hearing, following other Trump nominees. His prior SEC and U.S. Attorney roles lack intelligence qualifications. The Senate Intelligence Committee will continue confirmation proceedings with expected Democratic opposition.

- A cyberattack on Japanese firm Nichirei disrupted KFC supply chains; systems are being restored. The incident shows cyberattacks now threaten physical operations beyond IT. Nichirei is recovering and KFC supplies should normalize.

- African shoppers are buying from Amazon and Walmart via package-forwarding startups like Senegal's Afrety, which bypass lack of bank cards and street addresses. The intermediaries ship goods to doorsteps using tech and internet growth. This extends global retailers' reach without local branches.

- A UNESCO panel will urge Japan to revise exhibits at Sado Island gold mines, citing forced Korean labor in WWII per South Korea's claim. The draft recommendation is compiled. Japan faces pressure to alter displays or risk heritage compliance issues.

- The Trump administration replaced a slavery exhibition at George Washington's Philadelphia home with a version historians say is inaccurate. Philadelphia's mayor and others criticized the swap. The change modifies the site's public historical narrative.

- New Zealand confirmed its first H5N1 case in a brown skua found on a Wellington beach. Biosecurity minister asks public to report groups of three or more sick or dead birds. Surveillance intensifies to protect vulnerable native bird species from spread.

- Iran released an American citizen detained since December 2024 and allowed departure; Trump called it a goodwill gesture. U.S.-Iran hostilities persist. The move signals a limited diplomatic opening.

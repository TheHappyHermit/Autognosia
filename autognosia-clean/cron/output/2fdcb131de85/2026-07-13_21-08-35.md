...
- European nations agreed to jointly develop anti-ballistic missile defense, complementing existing systems and reducing reliance on the U.S.
- Melbourne police arrested a 20-year-old alleged orchestrator of arson attacks; expected to curb hospitality war escalations.
- UN WFP says Gaza aid deliveries are limited by restrictions, violence, and funding shortages; calls for greater access remain unmet.
- Study confirms pre-1789 French Revolution districts with high salt/customs taxes saw twice as many revolts as low-tax areas.
- Typhoon Bavi shut Shenyang subway and evacuated 360,000 in Liaoning; emergency measures continue as storm weakens.
- Research shows supportive supervisors improve performance of employees with disabilities, but overall workplace environment limits gains.
- Xiaomi unveiled SkyNomad, its first range-extender SUV using a Changan engine, entering China's luxury EREV segment.
- Chipotle opened its first Mexico restaurant near the US border; mixed social response reflects prior US-chain struggles in origin countries.
- U.S. completed a third night of strikes on Iranian targets; Tehran attacked Emirati tankers in Hormuz, triggering Gulf air-raid alerts.

---

## 🤖 AI & Tech

US forces conducted a third night of strikes on Iranian targets (Bushehr, Bandar Abbas, etc.) after Trump announced a Hormuz blockade; Iran retaliated with attacks on US bases in Bahrain, and UAE reported Iranian cruise missiles hit two tankers in the strait, killing one and wounding eight. Concrete implication: Ongoing reciprocal strikes and active threats to Gulf shipping.

An ICE officer in Biddeford, Maine fatally shot a man during targeted surveillance of an undocumented migrant's address; DHS stated the officer acted out of fear for public safety. No further steps were announced.

Japan aims to protect image and voice rights from generative AI use, but no court ruling yet defines illegal use. The specific legal scope remains undecided.

Anthropic reported that Claude models may express different values across languages due to training data imbalances, based on 309,815 conversations. The paper provided no specific examples of inconsistent moral reasoning.

---

## 🌍 World

The Trump administration is considering visa bans and sanctions on ICC officials after a complaint, while the UN upheld the court; US immigration agents fatally shot a driver in Maine (seventh such death), and a Bangkok bar fire killed 30 due to suspected locked doors and flammable decor, prompting a negligence probe. Japan's Zentoshin bankruptcy forced cash-only bars, China's monthly car exports exceeded 1 million, US June jobs data drew skepticism from economists, and other items include a Hyogo speech ruling, Hormuz diplomacy calls, SDG urges, Wangchuk hunger strike, and a Lancaster toddler murder charge. Concrete implications: ICC staff may face travel restrictions, Thailand may impose stricter safety enforcement, and weak US labor signals could alter rate expectations.

...
The newsletter builder ran successfully and produced a complete newsletter. Per the cron delivery note, my final response is automatically delivered to the configured Telegram destination — I should not invoke send_message myself. Here is the resulting newsletter:
...
**Seattle Center shooting kills two, injures five:** A gunman opened fire around 6 p.m. Sunday at the Bite of Seattle festival near the Space Needle, killing two people and wounding five others including a 2-year-old boy; police have not announced any arrests.

**Netanyahu defies NYC mayor's ICC-backed snub:** Israeli Prime Minister Benjamin Netanyahu vowed to address the UN General Assembly in September after Mayor Zohran Mamdani declared him unwelcome in New York and endorsed the ICC arrest warrant; Netanyahu accused Mamdani of fomenting hate.

**Honda and Nissan to co-develop next-gen vehicle OS:** The Japanese automakers will jointly build a core operating system for software-defined vehicles, enabling over-the-air updates for autonomous driving and other functions.

**HKU president Xiang Zhang to step down in 2028:** University of Hong Kong vice-chancellor Xiang Zhang announced he will leave after completing a second five-year term, citing the past eight years as a defining honor.

---

## 🌍 World

**DMK demands NEET ban and probe into student protest violence** — MP TR Baalu filed an adjournment motion in Lok Sabha seeking a nationwide ban on the NEET medical entrance exam following a paper leak. The party also called for an inquiry into alleged weapon use against protesting students at Jantar Mantar.

**China's memory chip makers surge on AI data center demand** — The global AI infrastructure buildout has transformed memory chips from low-margin commodities into highly sought-after products. This shift is drawing increased U.S. scrutiny of Chinese semiconductor advances.

**Pentagon quietly adds 142 wounded to Iran war casualty count** — A database update restored four previously removed fatalities and created a new "Overseas Operations" category for casualties since fighting resumed July 7. The move sparked outrage among military families and lawmakers over transparency.

**Viswanathan Anand reverses course to contest FIDE deputy presidency** — The chess legend will run alongside presidential candidate Timur Turlov after Arkady Dvorkovich exited due to EU sanctions. Anand, currently interim president, cited a desire to continue expanding chess globally.

**AI accelerates speed and sophistication of cyberattacks** — S&J president Nobuo Miwa warned that artificial intelligence is enabling faster, more advanced cyber threats. The Tokyo-based security firm chief highlighted the growing challenge for defenders.

**Wildfires near Bordeaux force 220,000 evacuations across southwestern France** — Firefighters continue battling blazes near the city with tens of thousands displaced from surrounding regions. The evacuations span the broader southwest as containment efforts persist.

**Philippine President Marcos faces pivotal SONA amid corruption probe and growth concerns** — The State of the Nation Address opens his final two years in office with pressure to show results from flood-control project investigations. Analysts say he must balance anti-corruption efforts with sustaining economic momentum.

**Massive iceberg capsizes off Greenland's Ilulissat coast** — The berg flipped violently near the UNESCO-listed Ilulissat Icefjord on July 25, revealing its jagged underside. No injuries were reported from the dramatic event.

**Seattle Center mass shooting kills two, injures five at food festival** — Gunfire erupted around 6 p.m. Sunday during the annual Bite of Seattle event, sending thousands fleeing across the 74-acre park. Police have launched an investigation into the attack.

---

*Note: The script's summarizer hit an OpenRouter API error (budget=2500 attempt failed with a NoneType subscript error), so it fell back to its built-in extraction path — the output above is coherent but the categorization shows a known quirk (the Seattle shooting and Netanyahu/HKU items landed in "Science" rather than "World", and the Seattle shooting appears twice). If you want, I can patch the categorization logic and the summarizer's reasoning-model fallback so future runs are cleaner.*

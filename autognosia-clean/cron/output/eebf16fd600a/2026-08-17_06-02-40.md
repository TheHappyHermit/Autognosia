...
**XRP sentiment hits three-month bearish extreme** as price drops 7.8% this month to $1.00 while Bitcoin fell 0.5% and Ethereum gained 3.2%. Santiment data shows negative commentary across X, Reddit, and Telegram at highest level since May.

**IKEA launches UK home insurance via Urban Jungle partnership** after GlobalData survey found 30% of consumers would buy from the retailer, highest among alternative providers. The embedded insurance deal gives Urban Jungle massive distribution despite only 15.4% brand awareness.

**Purchase mortgage rates dip below refinance rates** with 30-year fixed at 6.54% versus 6.59% for refi, per Zillow data. The 15-year fixed purchase rate of 5.86% also sits 2 basis points below its refinance counterpart.

---

## 🤖 AI & Tech

**Watch Duty expands beyond wildfires:** The nonprofit app, known for real-time wildfire tracking, has launched nationwide flood coverage as its first step toward becoming a comprehensive disaster-warning platform.

---

## 🌍 World

**SECURE 2.0 mandates Roth catch-up for high earners:** Starting January 2026, workers earning $145,000+ in FICA wages must direct all catch-up contributions into Roth accounts. Advisors favor Roth for permanent tax-free growth and bankruptcy protections, though funds remain locked until age 59½.

**Dohrn cuts accidents 20% with AI cameras:** The Midwest LTL carrier installed dual-facing event recorders across its fleet a year ago, reducing accidents nearly 20%. CEO Robert Howard says carriers themselves are driving safety tech adoption to combat skyrocketing insurance premiums based on experience data.

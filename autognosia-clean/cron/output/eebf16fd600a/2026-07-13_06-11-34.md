...
- **UK/Iran:** UK banned the Iran-backed IMCR and Iran's Revolutionary Guard after IMCR claimed seven arson/vandalism attacks on Jewish sites. Parliament is expected to approve by week's end legislation making sabotage for these groups punishable by life imprisonment.

- **Puffiest planets:** Astronomers reported two Jupiter-sized planets orbiting TOI 791 with less than 6% of Jupiter's mass, the lowest density known, in July's MNRAS. No concrete implications beyond published observations.

- **Colorado wildfire pilot:** A pilot died when his aircraft crashed into Silver Jack Reservoir while fighting the Gold Mountain Fire (57 sq mi, 13% contained). The FAA is investigating; the fire remains largely uncontained.

- **Volkswagen jobs:** VW CEO warned of up to 100,000 total job cuts (50,000 additional beyond agreed 50,000) citing a 20% cost gap; labor representatives previously blocked a plan with four factory closures. The company is evaluating reduction needs across all units.

- **US weather:** Extreme heat shattered records in the West, fueling fires, while heavy rain and flash flooding hit the South. No stated next steps.

- **Europe wildfires:** Fontainebleau forest fire near Paris triggered evacuations and transit disruptions; in Spain, 10 remain missing from a blaze that killed 13. Firefighting continues with aerial and ground resources.

---

## 🤖 AI & Tech

1. A writer abandoned complex note apps for a local folder of markdown/text files accessed by multiple apps, finding the minimal system persisted. The implication is that low-complexity setups can sustain personal workflows better than feature-rich tools.

2. Graham Platner's political implosion may benefit Democrats long-term, per an RSS summary with failed full content extraction. No concrete next steps are detailed.

3. Boston College research found workers 55+ in AI-exposed industries leave jobs more often via unemployment or choice, sometimes retiring early. This indicates AI accelerates older worker displacement or voluntary exit from the labor force.

---

## 🌍 World

- Vance will meet House Republicans Tuesday to push reopening the floor for Trump's legislative priorities after a recess standstill. Next step: Republicans could advance votes if conservative hardliners yield.
- Lindsey Graham died Saturday night; a report claims he joked while unwell and delayed seeking care until after a Sunday appearance. Implication: his Senate seat triggers a South Carolina appointment or special election.
- U.S. and Iran traded strikes over the Strait of Hormuz as of July 13, 2026. Implication: continued hostilities risk shipping disruption.
- Repeated ceasefire violations and emergency measures leave Iranians in uncertainty. Implication: sustained domestic strain and anger.
- Gibraltar and Spain will remove their land border, ending a 300-year setup. Implication: border-free movement changes daily life for locals.

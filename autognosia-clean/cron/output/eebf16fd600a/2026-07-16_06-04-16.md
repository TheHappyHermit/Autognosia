...
- Uganda discharged its last Ebola patient, leaving no active confirmed cases; a 42-day countdown to official Ebola-free status begins pending no new infections. DR Congo remains the outbreak epicenter with US travel restrictions extended.

- A bottom in US-China trade is identified, possibly ending the global tariff war that began April 2025; Christmas goods shipments may peak in August or September 2026 instead of October due to earlier scheduling.

- Trump said Hegseth urged him to pardon soldiers who "killed a lot of people," and he granted many pardons; no further action noted.

- Netanyahu cancelled a planned US trip next week to attend the delayed funeral of Sen. Lindsey Graham.

- Research indicates quantum teleportation could reduce photon loss in long-distance photon-based communications; no specific next steps provided.

- A natural peptide switches from calmodulin to cancer-associated midkine depending on ion environment, relevant to biosensor and drug discovery tools; full recognition mechanism unclear.

- An international team published a practical guide for global benefit-sharing using genetic databases in the journal Scientific Data.

- A reviewer found the corded Miele Guard M1 more powerful than the cordless Dyson V8 for pet cleanup and prefers it; no broader implication.

---

## 🤖 AI & Tech

OnePlus confirmed exits from US/EU markets due to lost "flagship killer" identity and DRAM costs, not product quality, implying a smaller global footprint. Google TV slowdown is from storage/background load and is fixable via settings adjustments and space cleanup. A productivity app revived an idle tablet; Signal Ring claims calibration-free blood pressure readings from trials; a gene edit cut rice cadmium 48% without yield loss, improving food safety.

---

## 🌍 World

- US Coast Guard redeployed six cutters from the Middle East to the western Pacific for maritime security operations with allies. Chinese analysts say this will not change the South China Sea balance of power.

- Japan attempted monetary tightening through balance-sheet reduction rather than interest rate hikes, as suggested by Kevin Warsh. The full results of this approach were not detailed in the available summary.

- Dominik Szoboszlai is poised to sign a new long-term Liverpool contract after prior extension talks stalled. The midfielder's signing would boost head coach Andoni Iraola with two years remaining on his current deal.

- US House members continue to face sexual misconduct allegations despite resignations and investigations. Calls for systemic reform and transparency persist.

- The nine most profitable airlines earned $25.11 billion combined before the Iran war, with Emirates top. The conflict has since invalidated that earnings snapshot.

- Sens. Kim and Warren sent a letter to CFPB acting director Vought questioning recent complaint portal changes. They argue the changes discourage consumers from seeking help.

- Chinese scholars claimed Beijing should have sovereignty over the Batanes Islands, drawing Manila's rejection. Analysts say the claim serves as a warning amid Japanese-Philippine border talks.

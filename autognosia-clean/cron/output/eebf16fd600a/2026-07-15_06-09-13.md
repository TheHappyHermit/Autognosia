...
**Brighton beach rapists jailed:** Three asylum seekers (Ahmadi, Alshafe, Al-Danasurt) received 18.5–21 years for raping a woman on Brighton beach. Each will serve two-thirds of sentence before parole and get six extra years on extended licence.

**IRS chief leads Trump accounts expansion:** Frank Bisignano (IRS/Social Security head) will oversee expansion of tax-deferred child savings accounts allowing $5k/yr contributions. He keeps current roles; accounts debuted July 4 with withdrawal restrictions until age 18.

**Human mobility model:** A model described daily movement patterns between homes, work, and other sites. No concrete next steps reported.

**Domino's board changes:** Domino's elected Corie Barry lead independent director and added Michael Creedon (Dollar Tree CEO) and Anneliese Olson (HP exec) as directors on the audit committee. Barry remains Best Buy CEO.

**India EC revision schedule:** Election Commission revised voter roll revision dates for six states; drafts publish July 31–Aug 10, final rolls by October. Goal is to add new and remove ineligible voters.

**US-Iran strikes escalation:** Trump warned US will intensify strikes on Iranian bridges and power plants in three days if no negotiation; current strikes hit air defenses. Iran continues retaliatory attacks on US bases; US monitors buried nuclear site.

**Foxen pet insurance:** Foxen partnered with Healthy Paws to offer renters 5% off pet insurance via its leasing platform. Enrollment embeds pet verification with accident/illness coverage.

**Canada wildfire smoke:** Over 830 Canadian wildfires push smoke into US from Great Lakes to New England. No further implications detailed.

---

## 🤖 AI & Tech

Waze introduced five features (motorcycle routes, personalized navigation, fewer interruptions, voice map edits) that may pull users from Apple Maps, while Samsung's Galaxy Z Flip 8 is expected to repeat prior hardware at a higher price, making discounted older flips more compelling. Apple's MacBook Neo shipments are projected to fall 40% from A18 Pro chip shortages, and a new device class combining bone-conduction earbuds with 4K cameras (e.g., Auriview X1) is entering the smart glasses market. Open-source smart speaker software is improving as Google/Amazon speakers worsen, some users now run local LLMs on old laptops to replace ChatGPT free tier, and New York Democrats proposed dropping "mother/father" terms with Gov. Hochul's response awaited.

---

## 🌍 World

Wholesale prices fell 0.3% in June (vs consensus unchanged), with goods down 1.4% on a 6.4% energy drop; core PPI rose 0.2%. The May PPI was revised from +1.1% to +0.6%, suggesting easing wholesale inflation that could feed into lower consumer prices.

Trump said ICE should continue traffic stops, calling them "important and effective" crime-fighting tools. The statement signals continued use of the tactic but no new formal policy change.
